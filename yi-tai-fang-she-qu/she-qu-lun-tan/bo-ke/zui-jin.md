...
Posted by Danny Ryan on September 19, 2019
...
#### Multi-client testnets <a id="multi-client-testnets"></a>
...
#### Network debugging and tools <a id="network-debugging-and-tools"></a>

![Client metrics](https://blog.ethereum.org/img/2019/09/trinity-dashboard.png)
...
#### And then some <a id="and-then-some"></a>

![Eth2 on a pi](https://blog.ethereum.org/img/2019/09/eth2-pi.jpg)
